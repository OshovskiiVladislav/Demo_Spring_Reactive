...
@Component
public class MessageApiExceptionHandler extends AbstractErrorWebExceptionHandler  {

    public MessageApiExceptionHandler(ErrorAttributes errorAttributes, WebProperties.Resources resources,
